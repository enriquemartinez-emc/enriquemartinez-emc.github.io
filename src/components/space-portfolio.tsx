...
export default function SpacePortfolio() {
  ...
  return <main className="space-site" ref={root}>
    <header className="site-nav"><Link href="#launch" className="wordmark"><span>EM</span>{" // expedition"}</Link><nav className="nav-links" aria-label="Portfolio navigation"><Link href="#about">About</Link><Link href="#projects">Work</Link><a href="https://github.com/enriquemartinez-emc" target="_blank" rel="noreferrer">GitHub</a><a className="nav-signal" href="mailto:enrique.martinez.swe@outlook.com">Send signal</a></nav></header>
    <section className="journey" aria-label="Enrique's software expedition">
      ...
      <div className="journey-content">
        ...
        <section id="projects" className="story-beat"><div><p className="eyebrow">05 / Base in sight</p><h2>Projects awaiting transmission.</h2><p>Selected project placeholders are ready to be replaced with case studies, repositories, and live work.</p><div className="project-list"><a href="#featured">Operations console / placeholder</a><a href="#featured">Product workflow / placeholder</a><a href="#featured">Systems dashboard / placeholder</a></div></div></section>
        <section id="featured" className="story-beat right"><div><p className="eyebrow">06 / Final production</p><h2>The door is open.</h2><p>This is reserved for the flagship case study: the clearest proof of how the product, systems, and delivery decisions come together.</p><a className="story-link" href="https://github.com/enriquemartinez-emc" target="_blank" rel="noreferrer">View GitHub →</a></div></section>
        <section className="story-beat end-beat"><div><p className="eyebrow">07 / Expedition complete</p><h2>Keep exploring.</h2><p>{joke}</p><a className="story-link" href="#launch">Return to launch ↑</a></div></section>
      </div>
    </section>
